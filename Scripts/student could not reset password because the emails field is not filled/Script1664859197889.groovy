...
WebUI.setText(findTestObject('Object Repository/Page_Mahasiswa  Log in/input_Email_email'), '')

WebUI.click(findTestObject('Object Repository/Page_Mahasiswa  Log in/input_Email_submit'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Mahasiswa  Log in/p_The Email Address field is required'), 
    0)
