...
WebUI.setText(findTestObject('Object Repository/Page_Mahasiswa  Log in/input_Email_email'), 'roma.ulina.tif418@polban.ac.id')

WebUI.click(findTestObject('Object Repository/Page_Mahasiswa  Log in/input_Email_submit'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Mahasiswa  Log in/div_Alert                    Link Reset Pas_469a2d'), 
    0)
